...
namespace cost_3_fit_model_namespace {
...
class cost_3_fit_model final : public model_base_crtp<cost_3_fit_model> {

 private:
  int N;
  Eigen::Matrix<double, -1, 1> mileage__;
  Eigen::Matrix<double, -1, 1> vol_engine__;
  std::vector<double> price; 
  Eigen::Map<Eigen::Matrix<double, -1, 1>> mileage{nullptr, 0};
  Eigen::Map<Eigen::Matrix<double, -1, 1>> vol_engine{nullptr, 0};
 
 public:
  ~cost_3_fit_model() { }
  
  inline std::string model_name() const final { return "cost_3_fit_model"; }
  ...
  cost_3_fit_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "cost_3_fit_model_namespace::cost_3_fit_model";
    ...
    try {
      ...
      vol_engine__ = 
        Eigen::Matrix<double, -1, 1>::Constant(N,
          std::numeric_limits<double>::quiet_NaN());
      new (&vol_engine) Eigen::Map<Eigen::Matrix<double, -1, 1>>(vol_engine__.data(), N);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cost_3_fit_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cost_3_fit_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
...
using stan_model = cost_3_fit_model_namespace::cost_3_fit_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return cost_3_fit_model_namespace::profiles__;
}
